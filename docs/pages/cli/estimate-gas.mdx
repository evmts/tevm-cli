...
The command schema in [`packages/tevm-cli/src/commands/estimateGas.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/estimateGas.tsx) exposes:
...
[CLI overview](/cli) · [`tevm estimate-fees-per-gas`](/cli/estimate-fees-per-gas) · [`tevm get-account`](/cli/get-account)
