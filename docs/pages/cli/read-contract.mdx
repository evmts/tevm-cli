...
The command schema in [`packages/tevm-cli/src/commands/readContract.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/readContract.tsx) exposes:
...
[CLI overview](/cli) · [`tevm multicall`](/cli/multicall) · [`tevm action send-raw-transaction`](/cli/send-raw-transaction)
