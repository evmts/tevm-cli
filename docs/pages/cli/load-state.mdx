...
The command schema in [`packages/tevm-cli/src/commands/loadState.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/loadState.tsx) exposes:
...
[CLI overview](/cli) · [`tevm get-transaction`](/cli/get-transaction) · [`tevm mine`](/cli/mine)
