...
The command schema in [`packages/tevm-cli/src/commands/call.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/call.tsx) exposes:
...
[CLI overview](/cli) · [`tevm compile`](/cli/compile)
