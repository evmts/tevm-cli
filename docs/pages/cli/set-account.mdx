...
The command schema in [`packages/tevm-cli/src/commands/setAccount.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/setAccount.tsx) exposes:
...
[CLI overview](/cli) · [`tevm serve`](/cli/serve) · [`tevm set-code`](/cli/set-code)
