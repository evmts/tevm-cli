...
The command schema in [`packages/tevm-cli/src/commands/createContractEventFilter.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/createContractEventFilter.tsx) exposes:
...
[CLI overview](/cli) · [`tevm create-block-filter`](/cli/create-block-filter) · [`tevm create-event-filter`](/cli/create-event-filter)
