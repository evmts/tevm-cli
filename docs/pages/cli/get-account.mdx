...
The command schema in [`packages/tevm-cli/src/commands/getAccount.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/getAccount.tsx) exposes:
...
[CLI overview](/cli) · [`tevm estimate-gas`](/cli/estimate-gas) · [`tevm action get-balance`](/cli/get-balance)
