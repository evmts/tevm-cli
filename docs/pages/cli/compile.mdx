...
The command schema in [`packages/tevm-cli/src/commands/compile.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/compile.tsx) exposes:
...
[CLI overview](/cli) · [`tevm call`](/cli/call) · [`tevm contract`](/cli/contract)
