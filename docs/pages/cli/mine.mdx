...
The command schema in [`packages/tevm-cli/src/commands/mine.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/mine.tsx) exposes:
...
[CLI overview](/cli) · [`tevm load-state`](/cli/load-state) · [`tevm multicall`](/cli/multicall)
