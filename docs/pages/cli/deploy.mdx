...
The command schema in [`packages/tevm-cli/src/commands/deploy.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/deploy.tsx) exposes:
...
[CLI overview](/cli) · [`tevm create-event-filter`](/cli/create-event-filter) · [`tevm dump-state`](/cli/dump-state)
