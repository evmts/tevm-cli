...
The command schema in [`packages/tevm-cli/src/commands/getBlock.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/getBlock.tsx) exposes:
...
[CLI overview](/cli) · [`tevm action get-balance`](/cli/get-balance) · [`tevm get-block-number`](/cli/get-block-number)
