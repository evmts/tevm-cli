...
The command schema in [`packages/tevm-cli/src/commands/setCode.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/setCode.tsx) exposes:
...
[CLI overview](/cli) · [`tevm set-account`](/cli/set-account) · [`tevm set-nonce`](/cli/set-nonce)
