...
The command schema in [`packages/tevm-cli/src/commands/createEventFilter.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/createEventFilter.tsx) exposes:
...
[CLI overview](/cli) · [`tevm create-contract-event-filter`](/cli/create-contract-event-filter) · [`tevm deploy`](/cli/deploy)
