...
The command schema in [`packages/tevm-cli/src/commands/getEnsAddress.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/getEnsAddress.tsx) exposes:
...
[CLI overview](/cli) · [`tevm get-chain-id`](/cli/get-chain-id) · [`tevm get-ens-name`](/cli/get-ens-name)
