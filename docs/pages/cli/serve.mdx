...
The command schema in [`packages/tevm-cli/src/commands/serve.tsx`](https://github.com/evmts/tevm-cli/blob/main/packages/tevm-cli/src/commands/serve.tsx) exposes:
...
[CLI overview](/cli) · [`tevm action send-raw-transaction`](/cli/send-raw-transaction) · [`tevm set-account`](/cli/set-account)
